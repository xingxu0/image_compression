...
for f in folders:
	...
	for i in range(1, 101):#101):
		c = commands.getstatusoutput("/opt/libjpeg-turbo/bin/jpegtran -encode ../image_compression_github/image_compression/tbl_" + f + "" + " images/" + f + "_Q75/" + str(i) + ".jpg temp.jpg")
		print c
		...
		c = commands.getstatusoutput("/opt/libjpeg-turbo/bin/jpegtran -decode ../image_compression_github/image_compression/tbl_" + f + "" + " temp.jpg " + str(i) + "_out.jpg")
		#print c
