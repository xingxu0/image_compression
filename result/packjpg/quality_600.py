...
ls = open("exp_600_quality.out").readlines()
now_f = 0
i = 0
...
fig.savefig("tecnick_quality_pjg_600.png", bbox_inches='tight')
fig.savefig("tecnick_quality_pjg_600.eps", bbox_inches='tight')