...
root_folder = "psnr_transcoding_new_95_to_80_"
...
for t in qs:
	...
	if t != 100:
		...
		leg.append("Trans. from QP="+str(t))
	else:
...
#ax.legend(leg, 4)
ax.legend(leg, 2, fontsize=22, numpoints=1, ncol=1)

#ax2.legend(leg, 4)
tight_layout()
plt.tick_params(axis='both', which='major', labelsize=22)
plt.tick_params(axis='both', which='minor', labelsize=22)
savefig("Q_psnr_transcoding_new_95_%s.png"%(reso))
savefig("Q_psnr_transcoding_new_95_%s.eps"%(reso))
...
plt.tick_params(axis='both', which='major', labelsize=22)
plt.tick_params(axis='both', which='minor', labelsize=22)
savefig("Q_ssim_transcoding_new_95_%s.png"%(reso))
savefig("Q_ssim_transcoding_new_95_%s.eps"%(reso))
