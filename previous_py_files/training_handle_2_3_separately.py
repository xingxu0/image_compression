...
def create_table(comp, dep1_s, dep2_s):
	...
	for i in range(21):
		if comp == '0':
			co_dc[i] = lib.huff_encode_plus_extra_handle_2_separately(oc_dc[i], lib.bits_dc_luminance)
		else:
			co_dc[i] = lib.huff_encode_plus_extra_handle_2_separately(oc_dc[i], lib.bits_dc_chrominance)
