...
for f in folders:
	...
	for i in range(1, 101):#101):
		#print i
		c = commands.getstatusoutput("/opt/libjpeg-turbo/bin/jpegtran -encode ../image_compression_github/image_compression/tbl_" + f + "_all" + " images/" + f + "_Q75/" + str(i) + ".jpg temp.jpg")
		#print c
		...
		#continue
		c = commands.getstatusoutput("/opt/libjpeg-turbo/bin/jpegtran -decode ../image_compression_github/image_compression/tbl_" + f + "_all" + " temp.jpg " + str(i) + "_out.jpg")
		#print c
