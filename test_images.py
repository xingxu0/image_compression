...
for f in folders:
	...
	for i in range(1, 101):#101):
		c = commands.getstatusoutput("jpegtran -encode ../../../image_compression_github/image_compression/tbl_" + f + "_1_9_new" + " ../../images/" + f + "_Q75/" + str(i) + ".jpg temp.jpg")
		#	print c
		...
		c = commands.getstatusoutput("jpegtran -decode ../../../image_compression_github/image_compression/tbl_" + f + "_1_9_new" + " temp.jpg " + str(i) + "_out.jpg")
		#print c
