...
os.system("python training_2_3_dc_zerooff.py %s/train %s/table 1 9 0.003"%(root, root))
...
for f in tfs:
	c = commands.getstatusoutput("/opt/libjpeg-turbo-lossy/bin/jpegtran -encode %s/table 0.003 %s %s/temp.jpg"%(root, f, root))
