...
for b in dest_bpp:
	print b
	os.system("rm %s -rf"%("lromp3_bpp_"+str(b)))
	os.system("mkdir %s"%("lromp3_bpp_"+str(b)))
	for f in fs:
		...
		get_threshold_jpg("%s/%s.jpg"%("lromp3_bpp_"+str(b), fname + "_q" + str(q_)+"_t"+str(t_)+".jpg" ), t_, f_current, f_base)
